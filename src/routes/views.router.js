...
import { checkOwner, isAdmin, isUser, isUseroPremium } from "../middleware/auth.js";


viewsRouter.get('/products', viewsController.getAll);
viewsRouter.get('/creatProduct',isUseroPremium, viewsController.creatProduct);
viewsRouter.get('/myProducts',isUseroPremium, viewsController.getMyProducts);
viewsRouter.get('/editProduct/:id',isUseroPremium,checkOwner, viewsController.editProductbyId);
